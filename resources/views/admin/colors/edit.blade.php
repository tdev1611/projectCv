            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        Chỉnh sửa màu <b><i>{{ $color->name }}</i></b> </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"> Edit Color </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="lg-12 py-3 container">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-5 ">
                        {{-- content --}}
                        <form method="POST" id="formColor" action="{{ route('admin.colors.update', $color->id) }}">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3 ">
                                ...
                                <select class="form-select form-select-lg mb-3" aria-label="Large select example"
                                    ...
                                    <option value="1" @if ($color->status == 1) selected @endif
                                        {{ old('status') == 2 ? 'selected' : '' }}>
                                        Hiển thị
                                    </option>
                                    <option value="2" @if ($color->status == 2) selected @endif
                            ...
                            <table class="table " style="margin-left: 20px;">
                                ...
                                <tbody>
                                    @forelse ($colors as $color)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="badge bg-danger">
                                                    {{-- {{ route('admin.colors.delete', $color->id) }} --}}
                                                    <a href="" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdrop-{{ $color->id }}"
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="staticBackdrop-{{ $color->id }}"
                                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="staticBackdropLabel">Delete Color
                                                            <b>{{ $color->name }}</b>
                                                        </h5>
